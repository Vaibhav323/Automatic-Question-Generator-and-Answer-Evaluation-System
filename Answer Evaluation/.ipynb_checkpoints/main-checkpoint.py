...
def get_data_frame():
    ...
    print("Columns in the DataFrame:", list(df))
...
tk.Button(root, text="Browse Data Set", command=get_data_frame).grid(row=1, column=0)
tk.Button(root, text="Close", command=root.quit).grid(row=1, column=1)
